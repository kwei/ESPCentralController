...
class FileHandler:
    ...
    def Append(self,devieId,TargetId,rssList):
        ...
        np.savetxt("./cache/RSS_{}_to_{}.csv".format(devieId, TargetId), rssListNp, fmt='%10.0f', delimiter=",")
    ...
    def Clone(self,devieId,TargetId,start,end):
        ...
        # print(saveCSV)
        np.savetxt("./save/RSS_{}_to_{}.csv".format(devieId, TargetId), saveCSV , fmt='%10.0f', delimiter=",")
